...
tab1_update_new_initiatives <- tab1_update_subset |>
  anti_join(mica_subset, by = "id")

initiatives_complete <- mica_subset |> bind_rows(tab1_update_new_initiatives)
```
...
```{r}
initiatives_complete <- tab1_init |> left_join(initiatives_complete, by = "id")
```
