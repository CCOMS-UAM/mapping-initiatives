...
Several large-scale cohort studies have recently been or are currently being
...
[@panahiazar_empowering_2014],
with lack of interoperability being the most prominent one.
...
The initiatives are presented in Supplementary Table 1,
...
Nevertheless, it should be noted that these funding sources refer only to
...
would help pursue these goals, while being more cost-effective than
undertaking new international mega-cohorts [@larsen_pregnancy_2013].
Dedicating efforts to designing cohort studies with the challenges of
...
LF contributed to the data acquisition, and revised the manuscript critically.
...
825884 to the Synchros Consortium from the European Union’s Horizon 2020
