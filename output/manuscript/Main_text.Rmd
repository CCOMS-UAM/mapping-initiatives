...
Despite this, there are concerns about legal (i.e., data protection) and ethical
aspects, as well as methodological and infrastructure challenges
[@panahiazar_empowering_2014] that may hinder the potential benefits of
these integration studies. The most prominent of these challenges are
the harmonization process and the aggregated analyses performed on
the integrated cohorts.
_Harmonization_ is a necessary step for cohort integration, and refers to
practices aimed at improving the comparability of
variables reducing heterogeneity across studies [@lesko_collaborative_2018].
...
hereby defining _initiative_ as any project that has analysed and/or plans
to analyse data from different cohorts in an integrated manner, in order to
...
We define _initiative_ as any project that has analysed and/or plans
to analyse data from different cohorts in an integrated manner, in order to
draw conclusions from these data altogether, instead of accumulating evidence
by analyzing the data each cohort individually.
This integration may be achieved with different methodological and
