...
output:
  officedown::rdocx_document:
    ...
    reference_docx:  ../../www/Epidemilogy_template.docx
    fig_width:       6.73
    fig_asp:          .75
    number_sections: no
    tables:
...
We used three different sources to search for initiatives:
...
This search yielded `r total_N` initiatives, although a significant proportion
of their leading teams were inactive or unresponsive.
...
We conclude that the number of cohort integration initiatives is still low,
