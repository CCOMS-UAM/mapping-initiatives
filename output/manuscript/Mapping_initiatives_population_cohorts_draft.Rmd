...
*Introduction:* Medical research increasingly requires the analysis of
data across different cohorts, i.e. of data collected under different
study designs and legal/ethical constraints.
The integration of such cohorts is often difficult,
but some have proven themselves to better support multi-study research.
The "SYNergies for Cohorts in Health: integrating the ROle of all Stakeholders"
-- SYNCHROS -- project carried out mappings of
patient, clinical trial, and population cohorts.
The aim of this paper is to lay out the methodology and results of
the mapping focusing on initiatives that integrate population cohorts.

*Methods:* Three different sources were used to include the initiatives in
the mapping: 1) A systematic search carried out in the MEDLINE database;
2) Suggestions of potential initiatives to be included in the mapping
provided by partners of the SYNCHROS consortium and
European Commission scientific officers; and
3) Descendent searches in the references and links of the initiatives obtained
from the two previous sources.

*Results:* Fifty-eight initiatives that integrate population cohorts were found,
although a significant proportion of the leading teams
were inactive or unresponsive.
Topics, socio-environmental contexts, and populations addressed were
rather disparate, and there were high volumes of integrated data.
Most of the initiatives were lead by European and American institutions,
coming the integrated cohorts from these two continents as well.

*Conclusion:* The number of cohort integration initiatives is still low,
compared with massive cohort studies being carried out worldwide.
The existing initiatives and cohort studies should strive towards improving
transparency and availability of information.
We expect the Synchros repository to contribute to these goals,
enabling researchers to integrate cohorts and
find venues for collaborative research.
...
the aim of formulating this strategy,
...
The search terms was intended to produce a representative,
albeit non-exhaustive, list of initiatives.
These terms were selected and agreed upon by consensus among
...
name of the institution responsible for the initiative,
...
The country where the responsible institution was based and the countries
...
and one initiative that interated patient and clinical trial cohorts.
This resulted in the inclusion of another 48 initiatives that integrate
population cohorts.
Thus, a total of `r total_N_out` initiatives included.
...
under the assumption that those which did not provide information about their
activity were inactive, that percentage would drop to 69%.<!-- # TODO: Reivew sentence and compute -->
...
while others had not started to harmonize cohorts yet.
At least `r more_cohorts_expected_n_out` initiatives expected
...
addressed by `r prop_ageing_out` of the initiatives each, and
...
Also, the most up-to-date information of each initiative can be consulted
...
In fact, very few of the initiatives were found to harmonize and integrate
biological samples
...
<!-- # TODO: Include Latin America here after recoding continents? -->
...
Knowledge about restricted populations
