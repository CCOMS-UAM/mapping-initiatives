...
```{r access-metadata-derivate_vars, eval=FALSE}
...
```{r access-individual-data-derivate_vars, eval=FALSE}
...
suppressMessages( # Message when reading empty column names
    ...
    bind_rows( # Add additional labels for descriptives table
      tibble(
        header    = c(
          ...
          "Country of responsible institution",
          "Funding",
        ...
        subheader = c(
          ...
          NA_character_ |> rep(6)   # Harmonization strategy to Nº of continents
        )
      )
    )                                                                        |>
  ...
  ## TODO: Continue here (añadir headers para setting, access.metadata, access.individualdata, harmonizationstrategy, omics, team_activity, country_institution, funding)
)
