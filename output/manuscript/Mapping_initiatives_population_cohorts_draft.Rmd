...
Laura Alejandra Rico-Uribe^1^; <!-- # TODO: Laura's current affiliation -->
Ángel Rodríguez-Laso^2^;
Ellen Vorstenbosch^1,3^;
Adreas J. Weser^4^;
Laura Fincias^3^;
Yannick Marcon^5^;
Leocadio Rodriguez-Mañas^2^;
Josep María Haro^3,6^;
José Luis Ayuso-Mateos^1,7,8,\*^;
Daniel Morillo-Cuadrado^1,8^
...
^2^ CIBERFES (Network-based Biomedical Research Consortium,
area of Frailty and Healthy Ageing), Instituto de Salud Carlos III, Spain

^3^ Parc Sanitari Sant Joan de Déu, Barcelona, Spain

^4^ HUNT Research Centre, Norwegian University of Science and Technology,
Levanger, Norway

^5^ <!-- # TODO: Complete Yannick's affiliation details -->

^6^ Universitat de Barcelona, Barcelona, Spain

^7^ Department of Psychiatry, Universidad Autónoma de Madrid, Madrid, Spain

^8^ Instituto de Investigación Sanitaria La Princesa (IIS-LP),
...
through intensive stakeholder collaboration (www.synchros.eu).
<!-- # TODO: Ref. needed?. -->
